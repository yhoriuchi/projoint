...
The should look like the following: ![](../man/figures/screenshot_first.png){#id .class width=100% height=100%} 
...
![](../man/figures/screenshot_last.png){#id .class width=100% height=100%}

The complete HTML for the first conjoint task in this survey is available from [here](https://raw.githubusercontent.com/yhoriuchi/projoint/master/data-raw/task_last.html):
