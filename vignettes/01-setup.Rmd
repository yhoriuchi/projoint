...
![Last Task](../man/figures/screenshot_last.png){#id .class width=50% height=50%}

The complete HTML for the first conjoint task in this survey is available from [here](https://github.com/yhoriuchi/projoint/data-raw/task_last.html):
