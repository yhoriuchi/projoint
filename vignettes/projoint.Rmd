...
summary(output)
```
To plot the estimates, use `plot()`, but please note that the current version only shows the figure for profile-level MMs or AMCEs.
