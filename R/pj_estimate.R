...
#' @param .list a list generated by organize_data()
#' @param .estimand A character identifying the estimand: "mm" or "amce"
#' @param .method  A character identifying the method of correcting measurement error bias: "analytical", "simulation", or "bootstrap"
#' @param .irr NULL if IRR is calculcate using the repeated task. Otherwise, a numerical value
