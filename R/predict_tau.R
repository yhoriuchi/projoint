...
#'   .flipped = TRUE)
#'   
#' tau1 <- predict_tau(reshaped_data[[2]])
#' tau1
#' 
...
#'   .flipped = FALSE)
#'   
#' tau2 <- predict_tau(reshaped_data[[2]])
#' tau2
#' 
...
#'   .repeated = FALSE)
#'   
#' tau3 <- predict_tau(reshaped_data[[2]])
#' tau3

predict_tau <- function(
    .dataframe, # reshaped data: the second element of a list generated by reshape_conjoint
    .idvar = "id",
    .title = NULL
){
