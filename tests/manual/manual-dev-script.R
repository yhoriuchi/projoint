...
untar("../projoint_1.1.3.tar.gz", list = TRUE)

# Step 3. Test the tarball directly
devtools::check_built("../projoint_1.1.3.tar.gz")

# # Step 4. Optional local install test
# install.packages("../projoint_1.1.3.tar.gz", repos = NULL, type = "source")

# # sanity-check inside the tarball
# ct <- utils::untar("../projoint_1.1.3.tar.gz", list = TRUE)
